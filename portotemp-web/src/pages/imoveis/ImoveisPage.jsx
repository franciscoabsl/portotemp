...
import { Plus, Pencil, Trash2, Home, Percent } from 'lucide-react'
          ...
          {imoveis.map(i => (
            <div key={i.id} className="card p-5 flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="bg-slate-50 rounded-xl px-3 py-2.5">
                  ...
                  <p className="text-sm font-bold text-slate-800 mt-0.5">
                    R$ {Number(i.taxaLimpezaHospede).toFixed(2)}
                  </p>
              ...
              <div className="flex flex-wrap gap-1.5">
                ...
                {i.codigoFechadura && (
                  <span className="badge bg-amber-50 text-amber-700">🔑 {i.codigoFechadura}</span>
                )}
              </div>
            </div>
          ))}
